...
/// Namespace for tour period data, geographic lookups, and venue parsing
enum GeoData {

    /// All tour periods from FZShows, matching the index page titles
    static let tourPeriods: [TourPeriod] = [
    ...
    static func periodName(forFilename filename: String) -> String? {
    ...
    static let canadianProvinceAbbreviations: Set<String> = [
    ...
    static func parseLocation(from venue: String) -> (city: String?, state: String?, country: String?) {
